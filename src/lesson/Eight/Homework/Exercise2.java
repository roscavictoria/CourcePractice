...
//Make a Java program that would calculate the sum, average, the number of even and odd elements of an one-dimensional array and a two-dimensional array of type int.
